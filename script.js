...
submit.addEventListener("click", function (event) {
    ...
    const password = document.getElementById('pass').value; // Repeated password input value for sign-up
    const email = document.getElementById('email').value; // Email address input value for sign-up
